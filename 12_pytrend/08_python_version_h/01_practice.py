...
data = ['皮拉提斯','舞蹈','健身','撞球']
# '籃球','登山','健行','瑜珈','攀岩','游泳','自行車','狩獵','戲水','潛水','有氧','爬山','排球','滾球','衝浪','壁球','射箭','露營','拳擊','跑步','龍舟','划船','慢跑','馬拉松','蛇板','滑板','滑板車','高爾夫','溜冰','滑雪','馬術','鐵人','航海','健走','羽球','羽毛球','桌球','飛鏢','曲棍球','橄欖球','棒球','網球','足球','重量訓練','重訓','浮潛','釣魚','立槳',
...
#print(type(all_sports_csv))
#print(all_sports_csv)
#print('ok') 
