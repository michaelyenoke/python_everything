...
data = ['sup','sup 體驗','Stand Up Paddle','立式划槳','立槳衝浪','立槳','kayak','獨木舟','救生衣','溯溪鞋','防滑鞋','膠鞋','更衣帳']
...
supwater_csv=clean_2.to_csv().encode()
#print(supwater_csv)
print('ok') 
...
blob=bucket.blob('supwater_csv.csv')
blob.upload_from_string(supwater_csv)
print('ok') 
